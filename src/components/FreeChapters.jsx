  ...
  return (
    ...
    >
      <div className="overflow-hidden lg:relative">
        ...
        >
          <Pattern componentThemeColor={componentThemeColor} className="absolute -top-32 left-0 w-full sm:left-3/4 sm:-top-5 sm:ml-8 sm:w-auto md:left-2/3 lg:left-auto lg:right-2 lg:ml-0 xl:right-auto xl:left-2/3" />
          <div>
