    ...
    <svg aria-hidden="true" width={width} height={height} {...props}>
      <defs>
        <symbol id={`${id}-0`} width={size} height={size}>
          <rect className={`${themedConfig['fill-color']}`} width={size} height={size} />
          <circle
            className={`${themedConfig['darker-fill-color']}`}
            cx={size / 2}
            cy={size / 2}
            r={size * (13 / 40)}
          />
        ...
        <symbol id={`${id}-1`} width={size} height={size}>
          <circle
            className={`${themedConfig['light-fill-color']}`}
            cx={size / 2}
            cy={size / 2}
            r={size / 2}
          />
